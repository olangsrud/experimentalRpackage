...
#' 
#' With doCumSum = FALSE, output is "pMatrix" created by \code{pt_create_pTable}
#'
#' @param D \code{pt_create_pParams} parameter
#' @param V \code{pt_create_pParams} parameter
#' @param js \code{pt_create_pParams} parameter
#' @param ... \code{pt_create_pParams} parameters
...
Pmatrix <- function(D = 5, V = 3, js = 2, ..., doCumSum = TRUE) {
  if (requireNamespace("ptable", quietly = TRUE)) {
    pParams <- ptable::pt_create_pParams(D = D, V = V, js = js, ...)
